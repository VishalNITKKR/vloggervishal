...
function customizable_blogily_spbThemesNotification(){
  ...
  $notifications->Add("customizable_blogily_notification", "Unlock All Features with Customizable Blogily Premium", "
    
    Take advantage of the up to <span style='font-weight:bold;'>45% discount</span> and unlock all features with Customizable Blogily Premium. 
    The discount is only available for a limited time.

    <div>
    <a style='margin-bottom:15px;' class='button button-large button-secondary' target='_blank' href='https://superbthemes.com/customizable-blogily/'>Read more</a> <a style='margin-bottom:15px;' class='button button-large button-primary' target='_blank' href='https://superbthemes.com/customizable-blogily/'>Buy now</a>
    </div>
